     							...
     							<div class="col-md-12">
     								<div class="row">
     									<div class="col-md-8">
     										...
     										<h5 class="my-2 text-white" style="font-size: 
     										30px;"><?php echo $num; ?></h5>
     								...
     								<div class="row">
     									<div class="col-md-8">
                                                       <?php 
                                                          ...
                                                          $doctor = mysqli_query($connect,"
                                                            SELECT * FROM doctors WHERE status='Approved'");

                                                          $num2 = mysqli_num_rows($doctor);
                                                        ?>
     										<h5 class="my-2 text-white" style="font-size: 
     										30px;"><?php echo $num2; ?></h5>
     										<h5 class="text-white">Total</h5>
     								...
     								<div class="row">
     									<div class="col-md-8">
                                                       ...
                                                       $rep = mysqli_num_rows($re); 
                                                        ...
                                                        ?>
     										<h5 class="my-2 text-white" style="font-size: 
     										30px;"><?php echo $rep; ?></h5>
     										<h5 class="text-white">Total</h5>
     										<h5 class="text-white">Report</h5>
     										
     									</div>
     									<div class="col-md-4">
     										<a href="report.php"><i class="fa fa-flag-checkered fa-3x my-4" 
     										style="color: white;"></i></a>
     									</div>
     								...
     								<div class="row">
     									<div class="col-md-8">
                                                       <?php 
                                                        ...
                                                        ?>
     										<h5 class="my-2 text-white" style="font-size: 
     										30px;"><?php echo $num1; ?></h5>
     										<h5 class="text-white">Total</h5>
     										<h5 class="text-white">Job Request</h5>
     										
     									</div>
     									<div class="col-md-4">
     										<a href="job_request.php"><i class="fa fa-box-open fa-3x my-4" 
     										style="color: white;"></i></a>
     									</div>
     								...
     								<div class="row">
     									<div class="col-md-8">
                                                       ...
                                                       $inc = $row['profit'];
                                                        ...
                                                        ?>
     										<h5 class="my-2 text-white" style="font-size: 
     										30px;"><?php echo "$$inc"; ?></h5>
     										<h5 class="text-white">Total</h5>
     										<h5 class="text-white">Income</h5>
     										
     									</div>
     									<div class="col-md-4">
     										<a href="income.php"><i class="fa fa-hand-holding-usd fa-3x my-4" 
     										style="color: white;"></i></a>
     									</div>
